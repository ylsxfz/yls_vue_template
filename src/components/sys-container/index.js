...
const containers = {
  full: () => import('./components/sys-container-full.vue'),
  fullbs: () => import('./components/sys-container-full-bs.vue'),
  ghost: () => import('./components/sys-container-ghost.vue'),
  ghostbs: () => import('./components/sys-container-ghost-bs.vue'),
  card: () => import('./components/sys-container-card.vue'),
  cardbs: () => import('./components/sys-container-card-bs.vue')
}
