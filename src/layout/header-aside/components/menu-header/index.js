...
export default {
  name: 'sys-layout-header-aside-menu-header',
  mixins: [
    menuMixin
  ],
  render (h) {
    return <div
      flex="cross:center"
      class={ { 'sys-theme-header-menu': true, 'is-scrollable': this.isScroll } }
      ref="page">
      <div
        ref="content"
        class="sys-theme-header-menu__content"
        flex-box="1"
        flex>
        <div
          class="sys-theme-header-menu__scroll"
          flex-box="0"
      ...
      </div>
      {
        this.isScroll
          ? [
            <div
              class="sys-theme-header-menu__prev"
            ...
            <div
              class="sys-theme-header-menu__next"
              flex="main:center cross:center"
              flex-box="0"
